      ...
      >
        <div>
          ...
          <input
            ...
            required
            minLength={3}
            className="w-full rounded border border-slate-300 px-3 py-2 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500"
            placeholder="Brief description of the issue"
          />
          {title.length > 0 && title.length < 3 && (
            <p className="mt-1 text-xs text-amber-600">At least 3 characters</p>
          )}
        </div>
        ...
        <div>
          ...
          {description.length > 0 && description.length < 5 && (
            <p className="mt-1 text-xs text-amber-600">At least 5 characters</p>
          )}
        </div>
